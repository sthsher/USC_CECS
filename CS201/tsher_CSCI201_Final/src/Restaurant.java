...
public class Restaurant extends JFrame {
	...
	//new stuff
	private CookPanel cookPanel = new CookPanel(); 
	public static final String[] foodNames = new String[] {"steak dinner", "seafood dinner", "vegetarian dinner"};
	...
	public Restaurant() {
		...
		JLabel jlNumCooks = new JLabel("Number of Cooks");
		addComboBox(jp, jlNumCooks, jcbNumCooks, 2, 2);
		...
		addComponent(jp, jbRestaurant, 4, 1, GridBagConstraints.CENTER, 2, 1);
		...
		addComponent(jp, servedCustomerLabel, 4, 4, GridBagConstraints.CENTER, 2, 1);
		...
		jbRestaurant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				if (jbRestaurant.getText().equals("Start Restaurant")) {
					...
					cookFactory = new CookFactory(cookPanel, getNumCooks());
	...
	public int getNumCooks(){
		return jcbNumCooks.getItemAt(jcbNumCooks.getSelectedIndex());
	}
